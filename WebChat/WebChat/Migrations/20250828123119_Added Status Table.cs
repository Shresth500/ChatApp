        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatImagePath = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Status_AspNetUsers_SenderId",
                        column: x => x.SenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusUpdates_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Status_SenderId",
                table: "Status",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_StatusUpdates_ReceiverId",
                table: "StatusUpdates",
                column: "ReceiverId");
