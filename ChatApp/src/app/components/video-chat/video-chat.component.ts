  ...
  template: `
    <div class="relative h-full w-full">
      ...
      >
        ...
        <button
          (click)="acceptCall()"
          class="bg-green-500 items-center gap-2 hover:bg-gray-700 shadow-xl text-white font-bold py-2 px-4 rounded-full flex"
        >
        ...
        <button
          (click)="declineCall()"
          class="bg-red-500 items-center gap-2 hover:bg-gray-700 shadow-xl text-white font-bold py-2 px-4 rounded-full flex"
        >
        ...
        <button
          (click)="endCall()"
          class="bg-red-500 items-center gap-2 hover:bg-red-700 shadow-xl text-white font-bold py-2 px-4 rounded-full flex"
        >
          <mat-icon>call_end</mat-icon>
          <span>End Call</span>
        </button>
...
export class VideoChatComponent implements OnInit {
  ...
  async endCall() {
    if (this.peerConnection) {
      ...
      const stream = this.localVideo.nativeElement
        .srcObject as unknown as MediaStream;
